...
#define Merge(T)                                                                                                                                                                        \
  void merge_##T(queuetreenode_##T *dst, queuetreenode_##T *src, int dstbegin, int srcbegin, int srcen) {                                                                               \
...
#define NodeInsert(T)                                                          \
  void nodeinsert_##T(treenode_##T *this, void (*func)(treenode_##T * node)) { \
    children->push(node);                                                      \
  }
#define NodeDFS(T)                                                          \
  void nodedfs_##T(treenode_##T *this, void (*func)(treenode_##T * node)) { \
    if (!this) return;                                                      \
    func(this);                                                             \
...
#define NodeBFS(T)                                                                                                                                                   \
  void nodebfs_##T(treenode_##T *this, void (*func)(treenode_##T * node)) {                                                                                          \
...
#define DeleteTreeNode(T)                       \
  void deletetreenode_##T(treenode_##T *this) { \
    this->dfs(this, free);                      \
  }
...
#define DeleteTree(T)                        \
  tree_##T *deletetree_##T(tree_##T *this) { \
